            ...
            <div class="col-md-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h3 class="card-title mt-1"><?php echo e(__('Job Categories List')); ?></h3>
                    ...
                    <table class="table table-striped table-bordered data_table">
                        ...
                        <tbody>
                            ...
                            <tr id="jcategory-bulk-delete">
                                ...
                                <td>
                                    <a href="<?php echo e(route('admin.jcategory.edit', $jcategory->id)); ?>" class="btn btn-info btn-sm"><i class="fas fa-pencil-alt"></i><?php echo e(__('Edit')); ?></a>

                                    <form  id="deleteform" class="d-inline-block" action="<?php echo e(route('admin.jcategory.delete', $jcategory->id )); ?>" method="post">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\harminder\multipurpose_website_cms\core\resources\views/admin/job/job-category/index.blade.php ENDPATH**/ ?>