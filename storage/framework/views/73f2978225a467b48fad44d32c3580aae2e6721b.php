...
<div class="header-extra d-flex align-items-center">
    ...
    <?php if( $visibility->is_quote_page == 1): ?>
        <div class="navbar-btn">
            <a href="<?php echo e(route('front.quot')); ?>"><?php echo e(__('Gate A Quote')); ?><i class="fal fa-long-arrow-right"></i></a>
        </div>
    <?php endif; ?>
</div><?php /**PATH C:\xampp\htdocs\harminder\codecanyon-30127235-skynet-multipurpose-laravel-cms\multipurpose_website_cms\core\resources\views/front/partials/menu/nav-item.blade.php ENDPATH**/ ?>